...
run_command "safe_symlink /home/$SUDO_USER/dotfiles/configs/hypr/hyprland.conf /home/$SUDO_USER/.config/hypr/hyprland.conf" "Symlink hyprland config (force)" "yes" "no"
...
run_command "safe_symlink /home/$SUDO_USER/dotfiles/configs/dunst /home/$SUDO_USER/.config/dunst" "Symlink dunst config (force)" "yes" "no"
